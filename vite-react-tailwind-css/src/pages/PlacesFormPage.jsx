...
//             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 mt-2 gap-2">
...
//               "add check in and out times, remember to have some time window for cleaning for cleaning the room between guests"
//             )}
...
export default function PlacesFormPage() {
  ...
  const [price,setPrice] = useState(100);// Added state variable
